...
let correctIcon =
  '<div class="icon coreect-icon"><i class="fa-solid fa-check"></i></div>';
let incorrectIcon =
  '<div class="icon wrong-icon"><i class="fa-solid fa-xmark"></i></div>';
